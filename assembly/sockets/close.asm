...
_write:
	...
	mov edx, 78 ; move len bytes to write into edx
	mov ecx, response ; move addr of res var into ecx
	mov ebx, esi ; move f descriptor into ebx (accepted socket id)
	mov eax, 4 ; invoke SYS_WRITE
	int 80h

_close:

	mov ebx, esi ; esi -> ebx (accepted socket f descriptor)
